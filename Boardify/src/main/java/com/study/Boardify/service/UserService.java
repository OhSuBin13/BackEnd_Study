...
import com.study.Boardify.dto.user.UserCntDto;
...
public class UserService {
    ...
    public BindingResult joinValid(UserJoinRequest req, BindingResult bindingResult) {
        ...
        if(req.getPassword().isEmpty()){
            bindingResult.addError(new FieldError("req", "loginId","비밀번호가 비어있습니다."));
        }
    ...
    public void edit(UserDto dto, String loginId){
        ...
        if(dto.getNewPassword().equals("")){
            ...
            loginUser.edit(encoder.encode(dto.getNewPassword()), loginUser.getNickname());
        }
    }
