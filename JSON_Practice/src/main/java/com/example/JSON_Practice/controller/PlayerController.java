package com.example.JSON_Practice.controller;

import com.example.JSON_Practice.domain.FootballTeam;
import com.example.JSON_Practice.domain.Player;
...
public class PlayerController {
    ...
    public String postOnePlayer(@RequestBody Player player){
        String response = String.format("<선수정보>\n이름 : %s\n등번호 : %d\n나이 : %d",
    ...
    public Player convertStringToPlayer1(@RequestBody String jsonStr) throws org.json.simple.parser.ParseException {
